...
const INTEGRATIONS: Integration[] = [
  ...
  { id: "whatsapp", name: "WhatsApp", desc: "Message leads via WhatsApp", category: "Communication", domain: "whatsapp.com", nangoId: null, status: "coming_soon" },
  { id: "telegram", name: "Telegram", desc: "Bot and messaging automation", category: "Communication", domain: "telegram.org", nangoId: null, status: "coming_soon" },
  ...
  { id: "discord", name: "Discord", desc: "Communities and bot integrations", category: "Communication", domain: "discord.com", nangoId: null, status: "coming_soon" },
  ...
  { id: "hubspot", name: "HubSpot", desc: "CRM and marketing platform", category: "CRM & Sales", domain: "hubspot.com", nangoId: null, status: "coming_soon" },
  ...
  { id: "airtable", name: "Airtable", desc: "Flexible database and spreadsheet", category: "Productivity", domain: "airtable.com", nangoId: null, status: "coming_soon" },
  { id: "clickup", name: "ClickUp", desc: "Project and task management", category: "Productivity", domain: "clickup.com", nangoId: null, status: "coming_soon" },
  { id: "asana", name: "Asana", desc: "Team and project tracking", category: "Productivity", domain: "asana.com", nangoId: null, status: "coming_soon" },
  ...
  { id: "zapier", name: "Zapier", desc: "Automate workflows between apps", category: "AI & Automation", domain: "zapier.com", nangoId: null, status: "coming_soon" },
  { id: "make", name: "Make", desc: "Advanced workflow automation", category: "AI & Automation", domain: "make.com", nangoId: null, status: "coming_soon" },
  { id: "stripe", name: "Stripe", desc: "Payment processing and billing", category: "Payments", domain: "stripe.com", nangoId: null, status: "apikey", apiKeyUrl: "https://dashboard.stripe.com/apikeys", apiKeyLabel: "Stripe Dashboard → API Keys" },
  ...
  { id: "instagram", name: "Instagram", desc: "Post and manage content", category: "Social Media", domain: "instagram.com", nangoId: null, status: "coming_soon" },
  { id: "twitter", name: "X (Twitter)", desc: "Post and monitor tweets", category: "Social Media", domain: "twitter.com", nangoId: null, status: "coming_soon" },
  { id: "linkedin", name: "LinkedIn", desc: "Professional network automation", category: "Social Media", domain: "linkedin.com", nangoId: null, status: "coming_soon" },
  { id: "facebook", name: "Facebook", desc: "Pages and ad management", category: "Social Media", domain: "facebook.com", nangoId: null, status: "coming_soon" },
  { id: "tiktok", name: "TikTok", desc: "Short video content automation", category: "Social Media", domain: "tiktok.com", nangoId: null, status: "coming_soon" },
  { id: "youtube", name: "YouTube", desc: "Video publishing and analytics", category: "Social Media", domain: "youtube.com", nangoId: null, status: "coming_soon" },
